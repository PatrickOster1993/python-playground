...
import tempclass as tmp


# Beispiel: Verwendung der Klasse
temperaturen = [12, 15.13, 14, 10, 9.11, 13, 11]
wochentage = ["Mo", "Di", "Mi", "Do", "Fr", "Sa", "So"]

analyse = tmp.TemperaturAnalyse(temperaturen, wochentage)
analyse.berechne_statistiken()
analyse.erstelle_dataframe()

# Konsolenausgaben
analyse.ausgabe_statistiken()
analyse.ausgabe_dataframe()

# Plotten
analyse.plot_temperaturen()
=======
# Analyse der Temperaturen
temperatures = np.array([12, 15.13, 14, 10, 9.11, 13, 11])
