...
class Magier:
    ...
    # Getter und Setter für Attribut Heilungskraft
    @property
    def heilungskraft(self):
        return self._heilungskraft

    @heilungskraft.setter
    def _heilungskraft(self, wert):
        if wert > 100:
            print("Lebenspunkte können nicht mehr als 100 sein!")
            print("#######################################")
        else:
            self._lebenspunkte = wert
    ...
    ### Konstruktor ###
    def __init__(self, name, lebenspunkte, heilungskraft, angriffskraft, ruestung):
        """Initialisiert einen Krieger mit den angegebenen Attributen."""
        self.name = name
        self.lebenspunkte = lebenspunkte
        self.heilungskraft = heilungskraft
        self.angriffskraft = angriffskraft
        self.ruestung = ruestung
